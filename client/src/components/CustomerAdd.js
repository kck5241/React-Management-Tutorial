...
class CustomerAdd extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Button variant="contained" color="primary" onClick={this.handleClikeOpen}>
                    고객 추가하기
                </Button>
                <Dialog open={this.state.open} onClose={this.handleClose}>
                    <DialogTitle>고객 추가</DialogTitle>
                    <DialogContent>
                        <input className={classes.hidden} accept="image/*" id="raised-button-file" type="file" file={this.state.file} value={this.state.fileName} onChange={this.handleFileCange}/><br/>
                        ...
                        <TextField label="생년월일" input tyep="text" name="day" value={this.state.day} onChange={this.handleValueChange}/><br/>
